...
class Ollama:
    ...
    async def retrieve_tools(self, lang_tools: list = []):
        ...
        if self.mcp_client is not None:
            ...
            console.print(f"[red]MCP client is not initialized. Cannot retrieve tools[/red]")
    ...
    async def invoke(self, user_query: str = '', state: Messages = None):
        ...
        if not user_query and not has_user_message:
            ...
            console.print("[yellow]Warning: Both user_query and user message in state provided." + 
